...
clear @s minecraft:large_amethyst_bud[custom_data~{bonchateau_monnaie:"pedisme"}] 1

# Ajouter 1 à l'argent en banque
scoreboard players add @s argent_banque 9

# Message de confirmation
title @s actionbar {"text":"💰 Dépôt de 1 Pedisme (équivalent 9 Peore)","color":"gold"}
